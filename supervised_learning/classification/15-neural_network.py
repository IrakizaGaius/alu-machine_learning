...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05, verbose=True, graph=True, step=100):
        ...
        Args:
            ...
            alpha (float): learning rate
            verbose (bool): if True, prints cost every step
            graph (bool): if True, plots the cost function
            step (int): number of iterations between each print
        Returns:
            A (ndarray): output of the network
            cost (float): cost of the model
        """
